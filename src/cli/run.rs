...
fn to_json<T: Serialize>(value: T) -> std::result::Result<Option<serde_json::Value>, color_eyre::Report> {
...
#[instrument(skip_all)]
pub fn run(command: Commands) -> std::result::Result<Option<serde_json::Value>, color_eyre::Report> {
	match command {
